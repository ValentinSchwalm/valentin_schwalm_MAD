...
class Converter {
    companion object {
        ...
        fun stringToGenre(string: String): List<Genre> {
            return string.split(separator).map { Genre.valueOf(it) }
        }

        @TypeConverter
        fun imagesToString(images: List<String>): String {
            return images.joinToString(separator) { it }
        }

        @TypeConverter
        fun stringToImages(string: String): List<String> {
            return string.split(separator).map { it }
        }
    }
}
...
class MovieRepository() : IMovieRepository {
    ...
    private var movies: MutableList<Movie> = arrayListOf(
        Movie(id = "tt0499549",
            title = "Avatar",
            year = "2009",
            genre = Converter.genresToString(listOf(Genre.ACTION, Genre.ADVENTURE, Genre.FANTASY)),
            director = "James Cameron",
            actors = "Sam Worthington, Zoe Saldana, Sigourney Weaver, Stephen Lang",
            plot = "A paraplegic marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMjEyOTYyMzUxNl5BMl5BanBnXkFtZTcwNTg0MTUzNA@@._V1_SX1500_CR0,0,1500,999_AL_.jpg",
        ...
        Movie(id = "tt0416449",
            title = "300",
            year = "2006",
            genre = Converter.genresToString(listOf(Genre.ACTION, Genre.DRAMA, Genre.FANTASY)),
            director = "Zack Snyder",
            actors = "Gerard Butler, Lena Headey, Dominic West, David Wenham",
            plot = "King Leonidas of Sparta and a force of 300 men fight the Persians at Thermopylae in 480 B.C.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMTMwNTg5MzMwMV5BMl5BanBnXkFtZTcwMzA2NTIyMw@@._V1_SX1777_CR0,0,1777,937_AL_.jpg",
        ...
        Movie(id = "tt0848228",
            title = "The Avengers",
            year = "2012",
            genre = Converter.genresToString(listOf(Genre.ACTION, Genre.SCIFI, Genre.THRILLER)),
            director = "Joss Whedon",
            actors = "Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth",
            plot = "Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMTA0NjY0NzE4OTReQTJeQWpwZ15BbWU3MDczODg2Nzc@._V1_SX1777_CR0,0,1777,999_AL_.jpg",
        ...
        Movie(id = "tt0993846",
            ...
            year = "2013",
            genre = Converter.genresToString(listOf(Genre.BIOGRAPHY, Genre.COMEDY, Genre.COMEDY)),
            director = "Martin Scorsese",
            actors = "Leonardo DiCaprio, Jonah Hill, Margot Robbie, Matthew McConaughey",
            plot = "Based on the true story of Jordan Belfort, from his rise to a wealthy stock-broker living the high life to his fall involving crime, corruption and the federal government.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BNDIwMDIxNzk3Ml5BMl5BanBnXkFtZTgwMTg0MzQ4MDE@._V1_SX1500_CR0,0,1500,999_AL_.jpg",
        ...
        Movie(id = "tt0816692",
            title = "Interstellar",
            year = "2014",
            genre = Converter.genresToString(listOf(Genre.ADVENTURE, Genre.DRAMA, Genre.SCIFI)),
            director = "Christopher Nolan",
            actors = "Ellen Burstyn, Matthew McConaughey, Mackenzie Foy, John Lithgow",
            plot = "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMjA3NTEwOTMxMV5BMl5BanBnXkFtZTgwMjMyODgxMzE@._V1_SX1500_CR0,0,1500,999_AL_.jpg",
        ...
        Movie(id = "tt0944947",
            ...
            year = "2011 - 2018",
            genre = Converter.genresToString(listOf(Genre.ADVENTURE, Genre.DRAMA, Genre.FANTASY)),
            director = "N/A",
            actors = "Peter Dinklage, Lena Headey, Emilia Clarke, Kit Harington",
            plot = "While a civil war brews between several noble families in Westeros, the children of the former rulers of the land attempt to rise up to power. Meanwhile a forgotten race, bent on destruction, plans to return after thousands of years in the North.",
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BNDc1MGUyNzItNWRkOC00MjM1LWJjNjMtZTZlYWIxMGRmYzVlXkEyXkFqcGdeQXVyMzU3MDEyNjk@._V1_SX1777_CR0,0,1777,999_AL_.jpg",
        ...
        Movie(id = "tt2306299",
            title = "Vikings",
            year = "2013–2020",
            genre = Converter.genresToString(listOf(Genre.ACTION, Genre.DRAMA, Genre.HISTORY)),
            director = "N/A",
            ...
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMjM5MTM1ODUxNV5BMl5BanBnXkFtZTgwNTAzOTI2ODE@._V1_.jpg",
        ...
        Movie(id = "tt0903747",
            title = "Breaking Bad",
            year = "2008–2013",
            genre = Converter.genresToString(listOf(Genre.CRIME, Genre.DRAMA, Genre.THRILLER)),
            director = "N/A",
            ...
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMTgyMzI5NDc5Nl5BMl5BanBnXkFtZTgwMjM0MTI2MDE@._V1_SY1000_CR0,0,1498,1000_AL_.jpg",
        ...
        Movie(id = "tt2707408",
            title = "Narcos",
            year = "2015-",
            genre = Converter.genresToString(listOf(Genre.BIOGRAPHY, Genre.CRIME, Genre.DRAMA)),
            director = "N/A",
            ...
            images = Converter.imagesToString(listOf("https://images-na.ssl-images-amazon.com/images/M/MV5BMTk2MDMzMTc0MF5BMl5BanBnXkFtZTgwMTAyMzA1OTE@._V1_SX1500_CR0,0,1500,999_AL_.jpg",
